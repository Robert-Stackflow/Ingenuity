...
public class ChatInputStyle extends Style {
    ...
    public void setShowSelectAlbumBtn(boolean showSelectAlbumBtn) {
        this.showSelectAlbumBtn = showSelectAlbumBtn;
    }
    ...
    public void setVoiceBtnBg(Drawable voiceBtnBg) {
        this.voiceBtnBg = voiceBtnBg;
    }
    ...
    public void setVoiceBtnIcon(int voiceBtnIcon) {
        this.voiceBtnIcon = voiceBtnIcon;
    }
    ...
    public void setInputEditTextBg(int inputEditTextBg) {
        this.inputEditTextBg = inputEditTextBg;
    }
    ...
    public void setInputMarginLeft(int inputMarginLeft) {
        this.inputMarginLeft = inputMarginLeft;
    }
    ...
    public void setInputMarginRight(int inputMarginRight) {
        this.inputMarginRight = inputMarginRight;
    }
    ...
    public void setInputMarginTop(int inputMarginTop) {
        this.inputMarginTop = inputMarginTop;
    }
    ...
    public void setInputMarginBottom(int inputMarginBottom) {
        this.inputMarginBottom = inputMarginBottom;
    }
    ...
    public void setPhotoBtnBg(Drawable photoBtnBg) {
        this.photoBtnBg = photoBtnBg;
    }
    ...
    public void setPhotoBtnIcon(int photoBtnIcon) {
        this.photoBtnIcon = photoBtnIcon;
    }
    ...
    public void setCameraBtnBg(Drawable cameraBtnBg) {
        this.cameraBtnBg = cameraBtnBg;
    }
    ...
    public void setCameraBtnIcon(int cameraBtnIcon) {
        this.cameraBtnIcon = cameraBtnIcon;
    }
    ...
    public void setSendBtnIcon(int sendBtnIcon) {
        this.sendBtnIcon = sendBtnIcon;
    }
    ...
    public void setSendBtnBg(Drawable sendBtnBg) {
        this.sendBtnBg = sendBtnBg;
    }
    ...
    public void setSendCountBg(Drawable sendCountBg) {
        this.sendCountBg = sendCountBg;
    }
