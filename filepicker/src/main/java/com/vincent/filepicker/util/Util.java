...
//        long days = duration / (1000 * 60 * 60 * 24);
     ...
     */
    @NonNull
    public static String extractFileNameWithSuffix(@NonNull String url) {
     ...
     */
    @NonNull
    public static String extractFileNameWithoutSuffix(@NonNull String url) {
        try {
     ...
     */
    @NonNull
    public static String extractPathWithSeparator(@NonNull String url) {
     ...
     */
    @NonNull
    public static String extractPathWithoutSeparator(@NonNull String url) {
     ...
     */
    @NonNull
    public static String extractFileSuffix(@NonNull String url) {
        if (url.contains(".")) {
            return url.substring(url.lastIndexOf(".") + 1);
        } else {
            return "";
