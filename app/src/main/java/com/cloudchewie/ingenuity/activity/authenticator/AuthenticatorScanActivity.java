...
import com.cloudchewie.ingenuity.util.authenticator.QrCodeParser;
...
public class AuthenticatorScanActivity extends BaseActivity implements ImageAnalysis.Analyzer {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_authenticator_scan);
    ...
    private void startCamera() {
        ...
        cameraProviderFuture.addListener(() -> {
            ...
            cameraProvider.bindToLifecycle(AuthenticatorScanActivity.this, cameraSelector, preview, imageAnalysis);
    ...
    private void analyzeImage(ImageProxy imageProxy) {
        ...
        try {
            ...
            runOnUiThread(() -> {
                ...
                if (exist != null) {
                    IDialog dialog = new IDialog(AuthenticatorScanActivity.this);
                    ...
                    dialog.setOnClickBottomListener(new IDialog.OnClickBottomListener() {
                        ...
                        public void onPositiveClick() {
                            ...
                            IToast.showBottom(AuthenticatorScanActivity.this, getString(R.string.edit_token_success));
                    ...
                    IToast.showBottom(AuthenticatorScanActivity.this, getString(R.string.add_token_success));
                    LiveEventBus.get(EventBusCode.CHANGE_TOKEN.getKey()).post("");
                    finish();
                }
            });
