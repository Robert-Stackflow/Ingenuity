...
public class CropImageView extends TransformImageView {
    ...
    public void cropAndSaveImage(@NonNull Bitmap.CompressFormat compressFormat, int compressQuality,
                                 @Nullable BitmapCropCallback cropCallback, String filePath, String outPath) {
        cancelAllAnimations();
        ...
        ExifInfo exifInfoMy = null;
        if (getExifInfo() == null) {
            exifInfoMy = new ExifInfo(0, 0, 1);
        } else {
            exifInfoMy = getExifInfo();
        }

        if (TextUtils.isEmpty(getImageInputPath())) {
            ...
            cropParameters = new CropParameters(
                    ...
                    filePath, outPath, exifInfoMy);
        } else {
            cropParameters = new CropParameters(
                    mMaxResultImageSizeX, mMaxResultImageSizeY,
                    compressFormat, compressQuality,
                    getImageInputPath(), getImageOutputPath(), exifInfoMy);
        }
