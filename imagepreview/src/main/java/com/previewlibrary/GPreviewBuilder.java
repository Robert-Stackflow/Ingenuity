...
import com.previewlibrary.view.MyImageOperationButtonClickedListener;
...
public final class GPreviewBuilder {
    ...
    private GPreviewActivity.OnOperationButtonClickedListener onOperationButtonClickedListener;
    ...
    public GPreviewBuilder setOnOperationButtonClickedListener(GPreviewActivity.OnOperationButtonClickedListener listener) {
        if (listener != null)
            this.onOperationButtonClickedListener = listener;
        else
            this.onOperationButtonClickedListener = new MyImageOperationButtonClickedListener();
        return this;
    }
    ...
    public void start() {
        ...
        if (onOperationButtonClickedListener == null)
            onOperationButtonClickedListener = new MyImageOperationButtonClickedListener();
        BasePhotoFragment.setOnImageLongClickedListener(view -> {
            BottomSheet bottomSheet = new BottomSheet(view.getContext());
        ...
        GPreviewActivity.listener = onOperationButtonClickedListener;
