...
public class PhotoViewHolder<MESSAGE extends IMessage> extends BaseMessageViewHolder<MESSAGE>
    ...
    public void onBind(final MESSAGE message) {
        Log.d("xuruida", "bind:" + message.getFileName());
        ...
        if (mScroll) {
            ...
            mImageLoader.loadImage(mPhotoIv, message.getFilePath());
        }
        ...
        mPhotoIv.setOnClickListener(view -> {
            if (mMsgClickListener != null) {
                mMsgClickListener.onMessageClick(view, message, this);
            }
        });

        mPhotoIv.setOnLongClickListener(view -> {
    ...
    public void applyStyle(@NonNull MessageListStyle style) {
        ...
        mPhotoIv.setBorderRadius(TypedValue.COMPLEX_UNIT_PX, style.getPhotoMessageRadius());
