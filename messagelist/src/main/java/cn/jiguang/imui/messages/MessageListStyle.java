...
public class MessageListStyle extends Style {
    ...
    private int receiveBubbleDrawableTintList = -1;
    ...
    private int sendBubbleDrawableTintList = -1;
    ...
    public ColorStateList getSendBubbleDrawableTint() {
        if (sendBubbleDrawableTintList == -1) {
            return null;
        } else {
            return ContextCompat.getColorStateList(mContext, sendBubbleDrawableTintList);
        }
    }

    public void setSendBubbleDrawableTint(int resId) {
    ...
    public ColorStateList getReceiveBubbleDrawableTint() {
        if (receiveBubbleDrawableTintList == -1) {
            return null;
        } else {
            return ContextCompat.getColorStateList(mContext, receiveBubbleDrawableTintList);
        }
    }

    public void setReceiveBubbleDrawableTint(int resId) {
        ColorStateList colorStateList = ContextCompat.getColorStateList(mContext, resId);
        if (colorStateList != null) {
            this.receiveBubbleDrawable = resId;
        }
