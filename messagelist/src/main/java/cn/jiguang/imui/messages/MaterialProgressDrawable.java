...
public class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    private void setUp(final double diameter) {
        final int shadowYOffset = dp2px(mParent.getContext(), Y_OFFSET);
        final int shadowXOffset = dp2px(mParent.getContext(), X_OFFSET);
        int mShadowRadius = dp2px(mParent.getContext(), SHADOW_RADIUS);
