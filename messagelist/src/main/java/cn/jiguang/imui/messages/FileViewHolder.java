...
public class FileViewHolder<Message extends IMessage> extends BaseMessageViewHolder<Message> implements MsgListAdapter.DefaultMessageViewHolder {
    ...
    public FileViewHolder(View itemView, boolean isSender) {
        ...
        mImageCover = itemView.findViewById(R.id.aurora_tv_file_icon);
        mTvSize = itemView.findViewById(R.id.aurora_tv_file_size);
        mTvName = itemView.findViewById(R.id.aurora_tv_file_name);
        mContainer = itemView.findViewById(R.id.aurora_tv_file_container);
        if (isSender) {
    ...
    public void onBind(@NonNull final Message message) {
        ...
        mTvName.setText(message.getFileName() + "." + message.getFileType());
        mTvSize.setText(getSizeString(message.getFileSize()));
